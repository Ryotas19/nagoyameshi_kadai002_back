...
const SignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setError(null);
        try {
            // 【バグ修正点】password を password1 に修正しました
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-md">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg space-y-6">
                {error && <div className="text-red-500 text-center p-2 bg-red-100 rounded">
                 ...
                 <div>
                    ...
                    <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="w-full p-3 border rounded" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="password" id="password2" value={password2} onChange={(e) => setPassword2(e.target.value)} className="w-full p-3 border rounded" required />
                </div>
